...
const cardContent = {
  ...
  titles: [
    'The 6 Best Heritage Hotels for Families in India',
   ' Best Ski Resorts in India',
    'Vacation Homes for a Diwali Getaway',
   ' Incredible Rooftop Bars in Mumbai',
   ' Best Hill Stations for Skiing in India',
   ' Vacation Homes for a Holi Getaway',
   ' Amazing Rooftop Bars in Delhi',
